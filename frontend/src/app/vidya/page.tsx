                ...
                <div id="vidya-hero" className="mathco-hero-bg flex min-h-[60vh] sm:min-h-[70vh] flex-col gap-6 sm:gap-8 items-start justify-center p-4 sm:p-8 lg:p-16 @[480px]:gap-12 @[480px]:rounded-xl relative overflow-hidden">
                  ...
                  <div className="flex flex-col gap-4 sm:gap-6 relative z-10 max-w-2xl">
                    <h1 className="text-[var(--color-primary-white)] text-3xl sm:text-5xl lg:text-6xl font-medium leading-[1.1] tracking-tight">
                      Vidya LMS: Transform Learning Experiences
                    </h1>
                    <p className="text-[var(--color-primary-white)]/80 text-base sm:text-lg lg:text-xl font-normal leading-relaxed max-w-xl">
                      Empower educators and students with our comprehensive Learning Management System designed specifically for Indian educational institutions. Streamline course delivery, track progress, and enhance engagement.
                    </p>
            ...
            <div id="overview" className="flex flex-col gap-8 sm:gap-10 px-4 py-12 sm:py-16 @container">
              <div className="flex flex-col gap-4 sm:gap-6 text-center max-w-4xl mx-auto">
                ...
                <p className="text-[var(--color-neutral-dark)] mathco-body max-w-3xl mx-auto text-sm sm:text-base">
                  Vidya LMS provides everything you need to deliver exceptional educational experiences. From course creation to student assessment, manage your entire learning ecosystem in one powerful platform.
                </p>
              </div>
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 max-w-6xl mx-auto">
                ...
                <div className="glass-card rounded-2xl flex flex-col gap-4 p-4 sm:p-6 group">
                  ...
                  <div className="flex flex-col gap-3">
                    <h3 className="text-[var(--color-primary-violet)] mathco-h3 text-base sm:text-lg">Course Management</h3>
                    <p className="text-[var(--color-primary-violet)]/80 mathco-body-sm text-sm">
                      Create, organize, and deliver courses with ease. Upload content, set schedules, and manage enrollments all in one place.
                    </p>
                  </div>
                ...
                <div className="glass-card rounded-2xl flex flex-col gap-4 p-4 sm:p-6 group">
                  ...
                  <div className="flex flex-col gap-3">
                    <h3 className="text-[var(--color-primary-violet)] mathco-h3 text-base sm:text-lg">Assessment Tools</h3>
                    <p className="text-[var(--color-primary-violet)]/80 mathco-body-sm text-sm">
                      Design quizzes, assignments, and exams with automatic grading. Track student performance with detailed analytics and reports.
                    </p>
                  </div>
                  <div className="mt-auto">
                    <div className="w-6 h-6 text-[var(--color-teal)] opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                ...
                <div className="glass-card rounded-2xl flex flex-col gap-4 p-4 sm:p-6 group">
                  ...
                  <div className="flex flex-col gap-3">
                    <h3 className="text-[var(--color-primary-violet)] mathco-h3 text-base sm:text-lg">Student Analytics</h3>
                    <p className="text-[var(--color-primary-violet)]/80 mathco-body-sm text-sm">
                      Gain insights into student engagement, progress, and performance with comprehensive analytics and reporting dashboards.
                    </p>
                  </div>
                  <div className="mt-auto">
                    <div className="w-6 h-6 text-[var(--color-teal)] opacity-0 group-hover:opacity-100 transition-opacity duration-300">
            ...
            <div id="features-section" className="flex flex-col gap-8 sm:gap-10 px-4 py-12 sm:py-16 @container" style={{ backgroundImage: 'url(/bg-svg-1.svg)', backgroundSize: 'cover', backgroundPosition: 'center', backgroundRepeat: 'no-repeat', width: '100vw', marginLeft: 'calc(-50vw + 50%)', marginRight: 'calc(-50vw + 50%)' }}>
              <div className="flex flex-col gap-4 sm:gap-6 text-center max-w-4xl mx-auto">
                ...
                <p className="text-white/80 mathco-body max-w-3xl mx-auto text-sm sm:text-base">
                  Discover what makes Vidya LMS the preferred choice for educational institutions across India.
                </p>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 max-w-4xl mx-auto">
                ...
                <div className="p-6 sm:p-8 group hover:scale-105 transition-transform duration-300 relative" style={{ backgroundColor: 'transparent', borderLeft: '0.5px solid rgba(255, 255, 255, 1)', borderRight: '0.5px solid rgba(255, 255, 255, 1)', color: 'rgba(247, 247, 250, 1)' }}>
                  ...
                  <div className="flex flex-col h-full">
                    <h3 className="mathco-h3 text-lg sm:text-xl mb-4" style={{ color: 'var(--color-neutral-light)' }}>Interactive Content</h3>
                    <p className="mathco-body-sm text-sm" style={{ color: 'var(--color-white)' }}>
                      Create engaging lessons with multimedia content, videos, interactive quizzes, and collaborative assignments.
                    </p>
                  </div>
                </div>
                ...
                <div className="p-6 sm:p-8 group hover:scale-105 transition-transform duration-300 relative" style={{ backgroundColor: 'transparent', borderLeft: '0.5px solid rgba(255, 255, 255, 1)', borderRight: '0.5px solid rgba(255, 255, 255, 1)', color: 'rgba(247, 247, 250, 1)' }}>
                  ...
                  <div style={{ position: 'absolute', bottom: '0', right: '0', width: '6px', height: '6px', backgroundColor: 'rgba(255, 255, 255, 1)', transform: 'translate(50%, 50%)' }}></div>
                  <div className="flex flex-col h-full">
                    <h3 className="mathco-h3 text-lg sm:text-xl mb-4" style={{ color: 'var(--color-neutral-light)' }}>Mobile Access</h3>
                    <p className="mathco-body-sm text-sm" style={{ color: 'var(--color-white)' }}>
                      Access courses and materials anytime, anywhere with our responsive mobile-friendly platform designed for modern learners.
                    </p>
                  </div>
                </div>
                ...
                <div className="p-6 sm:p-8 group hover:scale-105 transition-transform duration-300 relative" style={{ backgroundColor: 'transparent', borderLeft: '0.5px solid rgba(255, 255, 255, 1)', borderRight: '0.5px solid rgba(255, 255, 255, 1)', color: 'rgba(247, 247, 250, 1)' }}>
                  ...
                  <div style={{ position: 'absolute', bottom: '0', right: '0', width: '6px', height: '6px', backgroundColor: 'rgba(255, 255, 255, 1)', transform: 'translate(50%, 50%)' }}></div>
                  <div className="flex flex-col h-full">
                    <h3 className="mathco-h3 text-lg sm:text-xl mb-4" style={{ color: 'var(--color-neutral-light)' }}>Communication Hub</h3>
                    <p className="mathco-body-sm text-sm" style={{ color: 'var(--color-white)' }}>
                      Foster collaboration with discussion forums, announcements, messaging, and real-time notifications to keep everyone connected.
                    </p>
                  </div>
                </div>
                ...
                <div className="p-6 sm:p-8 group hover:scale-105 transition-transform duration-300 relative" style={{ backgroundColor: 'transparent', borderLeft: '0.5px solid rgba(255, 255, 255, 1)', borderRight: '0.5px solid rgba(255, 255, 255, 1)', color: 'rgba(247, 247, 250, 1)' }}>
                  ...
                  <div style={{ position: 'absolute', bottom: '0', right: '0', width: '6px', height: '6px', backgroundColor: 'rgba(255, 255, 255, 1)', transform: 'translate(50%, 50%)' }}></div>
                  <div className="flex flex-col h-full">
                    <h3 className="mathco-h3 text-lg sm:text-xl mb-4" style={{ color: 'var(--color-neutral-light)' }}>Gradebook & Reports</h3>
                    <p className="mathco-body-sm text-sm" style={{ color: 'var(--color-white)' }}>
                      Comprehensive gradebook with customizable grading scales, progress reports, and exportable data for administrative needs.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div id="contact-section" className="flex flex-col gap-8 sm:gap-10 px-4 py-12 sm:py-16 @container">
              <div className="glass-card rounded-2xl p-8 sm:p-12 max-w-4xl mx-auto text-center">
                <div className="flex flex-col gap-4 sm:gap-6">
                  ...
                  <p className="text-[var(--color-neutral-dark)] mathco-body max-w-3xl mx-auto text-sm sm:text-base">
                    Experience the power of Vidya LMS and see how it can revolutionize your institution&apos;s learning management. Get in touch to schedule a demo or learn more about our features.
                  </p>
                </div>
