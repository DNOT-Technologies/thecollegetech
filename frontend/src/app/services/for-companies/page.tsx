              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 max-w-6xl mx-auto">
                ...
                <div className="glass-card rounded-2xl flex flex-col gap-4 p-4 sm:p-6 group">
                  ...
                  <div className="flex flex-col gap-3">
                    <h3 className="text-[var(--color-primary-violet)] mathco-h3 text-base sm:text-lg">Direct Hiring Services</h3>
                    <p className="text-[var(--color-primary-violet)]/80 mathco-body-sm text-sm">
                      We handle the entire hiring process for your company. From sourcing candidates to conducting assessments and making final selections, we ensure you get the right talent for your team.
                    </p>
                  </div>
                ...
                <div className="glass-card rounded-2xl flex flex-col gap-4 p-4 sm:p-6 group">
                  ...
                  <div className="flex flex-col gap-3">
                    <h3 className="text-[var(--color-primary-violet)] mathco-h3 text-base sm:text-lg">Candidate Shortlisting</h3>
                    <p className="text-[var(--color-primary-violet)]/80 mathco-body-sm text-sm">
                      We shortlist top candidates from colleges you specify. Our process identifies the best talent based on your requirements, saving you time and ensuring quality matches for your open positions.
                    </p>
                  </div>
                  <div className="mt-auto">
                    <div className="w-6 h-6 text-[var(--color-teal)] opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                ...
                <div className="glass-card rounded-2xl flex flex-col gap-4 p-4 sm:p-6 group">
                  ...
                  <div className="flex flex-col gap-3">
                    <h3 className="text-[var(--color-primary-violet)] mathco-h3 text-base sm:text-lg">Hackathon-Style Assessments</h3>
                    <p className="text-[var(--color-primary-violet)]/80 mathco-body-sm text-sm">
                      Our unique recruitment process uses hackathon-style projects based on your specific roles. Candidates work on real-world challenges, record demos, and we audit submissions to identify the best talent.
                    </p>
                  </div>
                  <div className="mt-auto">
                    <div className="w-6 h-6 text-[var(--color-teal)] opacity-0 group-hover:opacity-100 transition-opacity duration-300">
