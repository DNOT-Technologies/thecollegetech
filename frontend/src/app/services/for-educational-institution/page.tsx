            ...
            <div id="overview" className="flex flex-col gap-8 sm:gap-10 px-4 py-12 sm:py-16 @container">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 max-w-6xl mx-auto">
                ...
                <div className="glass-card rounded-2xl flex flex-col gap-4 p-4 sm:p-6 group">
                  ...
                  <div className="flex flex-col gap-3">
                    <h3 className="text-[var(--color-primary-violet)] mathco-h3 text-base sm:text-lg">Placement Management System</h3>
                    <p className="text-[var(--color-primary-violet)]/80 mathco-body-sm text-sm">
                      Our placement platform brings companies directly to your institution. We help shortlist candidates, manage student applications, track application status, and streamline the entire recruitment process to benefit both your college and students.
                    </p>
                  </div>
                  <div className="mt-auto">
                    <div className="w-6 h-6 text-[var(--color-teal)] opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                ...
                <div className="glass-card rounded-2xl flex flex-col gap-4 p-4 sm:p-6 group">
                  ...
                  <div className="flex flex-col gap-3">
                    <h3 className="text-[var(--color-primary-violet)] mathco-h3 text-base sm:text-lg">Tailored IT Infrastructure & Support</h3>
                    <p className="text-[var(--color-primary-violet)]/80 mathco-body-sm text-sm">
                      We provide custom IT solutions tailored to your institution&apos;s needs. Whether you need a specific application, website, or any other technology solution, we build it for you. Complete IT infrastructure management and dedicated support included.
                    </p>
                  </div>
                  <div className="mt-auto">
                    <div className="w-6 h-6 text-[var(--color-teal)] opacity-0 group-hover:opacity-100 transition-opacity duration-300">
            ...
            <div id="contact-section" className="flex flex-col gap-8 sm:gap-10 px-4 py-12 sm:py-16 @container">
              <div className="glass-card rounded-2xl p-8 sm:p-12 max-w-4xl mx-auto text-center">
                <div className="flex flex-col gap-4 sm:gap-6">
                  ...
                  <p className="text-[var(--color-neutral-dark)] mathco-body max-w-3xl mx-auto text-sm sm:text-base">
                    Let&apos;s discuss how our educational technology solutions can help your institution enhance learning outcomes and streamline operations. Get in touch to schedule a consultation.
                  </p>
                </div>
