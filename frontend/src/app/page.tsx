  ...
  return (
    ...
    >
      ...
      <div className="fixed top-0 left-0 right-0 z-50 px-6 pt-6">
        <header className="glass-nav rounded-2xl px-8 py-4 flex items-center justify-between whitespace-nowrap">
          <div className="flex items-center gap-4">  
            <h2 className="text-[var(--color-primary-violet)] text-xl font-bold leading-tight tracking-[-0.015em] mathco-h3">TheCollegeTech</h2>
          </div>
            <div className="flex flex-1 justify-end gap-8">
              <div className="flex items-center gap-9">
                ...
                <a className="text-[var(--color-primary-violet)]/80 text-sm font-medium leading-normal relative group transition-colors duration-300 hover:text-[var(--color-primary-violet)]" href="mailto:nikhil@thecollegetech.com">
                  Contact
                  <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-gradient-primary transition-all duration-300 group-hover:w-full"></span>
                </a>
              </div>
              <a href="mailto:nikhil@thecollegetech.com" className="mathco-button-primary flex min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-xl h-10 px-4 text-sm font-bold leading-normal tracking-[0.015em]">
          ...
          <div className="layout-content-container flex flex-col max-w-[960px] flex-1 mx-auto">
            <div className="@container">
              <div className="@[480px]:p-4">
                <div id="home" className="mathco-hero-bg flex min-h-[90vh] flex-col gap-8 items-start justify-center p-8 lg:p-16 @[480px]:gap-12 @[480px]:rounded-xl relative overflow-hidden">
                  
                  <div className="flex flex-col gap-6 relative z-10 max-w-2xl">
                    <h1 className="text-[var(--color-primary-violet)] text-5xl lg:text-7xl font-medium leading-[1.1] tracking-tight">
                      Power your institution with Management systems, AI, and more.
                    </h1>
                    <p className="text-[var(--color-primary-violet)]/80 text-lg lg:text-xl font-normal leading-relaxed max-w-xl">
                    ...
                    <div className="flex items-center gap-2 text-[var(--color-primary-violet)] cursor-pointer hover:gap-3 transition-all duration-300 mb-8">
                  ...
                  {/* Latest Updates Card */}
                  <div className="absolute bottom-8 right-8 glass-card rounded-2xl p-6 max-w-xs z-10">
            ...
            <div id="services" className="flex flex-col gap-10 px-4 py-16 @container">
              <div className="flex flex-col gap-6 text-center max-w-4xl mx-auto">
                <h1 className="text-[var(--color-primary-violet)] mathco-h2">
                  Why Choose TheCollegeTech?
                </h1>
                <p className="text-[var(--color-neutral-dark)] mathco-body max-w-3xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
                {/* Card 1 */}
                <div className="glass-card rounded-2xl flex flex-col gap-4 p-6 group">
                  ...
                  <div className="flex flex-col gap-3">
                    <h3 className="text-[var(--color-primary-violet)] mathco-h3 text-lg">Integrated Solutions</h3>
                    <p className="text-[var(--color-primary-violet)]/80 mathco-body-sm">
                ...
                <div className="glass-card rounded-2xl flex flex-col gap-4 p-6 group">
                  ...
                  <div className="flex flex-col gap-3">
                    <h3 className="text-[var(--color-primary-violet)] mathco-h3 text-lg">Customizable Services</h3>
                    <p className="text-[var(--color-primary-violet)]/80 mathco-body-sm">
                ...
                <div className="glass-card rounded-2xl flex flex-col gap-4 p-6 group">
                  ...
                  <div className="flex flex-col gap-3">
                    <h3 className="text-[var(--color-primary-violet)] mathco-h3 text-lg">Dedicated Support</h3>
                    <p className="text-[var(--color-primary-violet)]/80 mathco-body-sm">
            ...
            <div className="flex flex-col gap-12 px-4 py-16 @container">
              <div className="flex flex-col gap-6 text-center max-w-4xl mx-auto">
                <h1 className="text-[var(--color-primary-violet)] mathco-h2">
            ...
            <div className="flex flex-col gap-10 px-4 py-16 @container">
              ...
              <div className="max-w-4xl mx-auto">
                  ...
                  <div className="pt-8">
                    ...
                    <div className="flex items-center justify-center gap-4">
                      ...
                      <div className="text-left">
                        <div className="font-semibold text-[var(--color-primary-violet)] mathco-h3">Dr. Rajesh Kumar</div>
                        <div className="text-[var(--color-neutral-dark)] mathco-body-sm">Director of Placements, IIT Delhi</div>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex justify-center gap-2 mt-8">
                  <div className="w-3 h-3 rounded-full bg-[var(--color-primary-violet)]"></div>
                  <div className="w-3 h-3 rounded-full bg-[var(--color-primary-violet)]/30"></div>
                  <div className="w-3 h-3 rounded-full bg-[var(--color-primary-violet)]/30"></div>
                </div>
              </div>
            </div>
            
            <div id="products" className="flex flex-col gap-12 px-4 py-16 @container">
              <div className="flex flex-col gap-6 text-center max-w-4xl mx-auto">
                <h1 className="text-[var(--color-primary-violet)] mathco-h2">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
                ...
                <div className="glass-card rounded-2xl overflow-hidden group">
                  <div className="relative">
                    ...
                    ></div>
                    <div className="absolute top-4 left-4 bg-gradient-primary text-white px-3 py-1 rounded-full text-sm font-medium">
                      Placement Platform
                    </div>
                  </div>
                  <div className="p-6">
                    <h3 className="text-[var(--color-primary-violet)] mathco-h3 text-xl mb-3">Placeeasy</h3>
                    <p className="text-[var(--color-primary-violet)]/80 mathco-body-sm mb-4">
                    ...
                    <div className="flex items-center justify-between">
                      <span className="text-[var(--color-teal)] text-sm font-medium">Learn More</span>
                      <div className="w-6 h-6 text-[var(--color-teal)] opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                        <svg viewBox="0 0 24 24" fill="currentColor">
                          <path d="M8.59 16.59L13.17 12L8.59 7.41L10 6L16 12L10 18L8.59 16.59Z"/>
                        </svg>
                ...
                <div className="glass-card rounded-2xl overflow-hidden group">
                  ...
                  <div className="p-6">
                    <h3 className="text-[var(--color-primary-violet)] mathco-h3 text-xl mb-3">Vidya LMS</h3>
                    <p className="text-[var(--color-primary-violet)]/80 mathco-body-sm mb-4">
                ...
                <div className="glass-card rounded-2xl overflow-hidden group">
                  ...
                  <div className="p-6">
                    <h3 className="text-[var(--color-primary-violet)] mathco-h3 text-xl mb-3">IT Services</h3>
                    <p className="text-[var(--color-primary-violet)]/80 mathco-body-sm mb-4">
            ...
            <div className="flex flex-col gap-10 px-4 py-16 @container">
              <div className="glass-card rounded-2xl p-12 max-w-4xl mx-auto text-center">
                ...
                <div className="flex flex-col sm:flex-row gap-4 mt-8">
                  <a href="mailto:nikhil@thecollegetech.com" className="mathco-button-primary flex min-w-[140px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-xl h-12 px-6 text-base font-bold leading-normal tracking-[0.015em]">
          ...
          <div className="max-w-6xl mx-auto px-4 py-16">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
              <div className="lg:col-span-2">
                <h3 className="text-[var(--color-accent-mint)] mathco-h3 mb-4">TheCollegeTech</h3>
                <p className="text-white/80 mathco-body max-w-md mb-6">
                ...
                <div className="flex gap-4">
                  <a href="#" className="w-10 h-10 bg-white/10 rounded-full flex items-center justify-center hover:bg-[var(--color-accent-mint)] hover:text-[var(--color-primary-violet)] transition-colors duration-300">
              ...
              <div>
                <h4 className="text-[var(--color-accent-mint)] mathco-h3 mb-4">Solutions</h4>
                <ul className="space-y-3">
                  <li><a href="#" className="text-white/80 mathco-body-sm hover:text-[var(--color-accent-mint)] transition-colors duration-300">Placeeasy</a></li>
                  <li><a href="#" className="text-white/80 mathco-body-sm hover:text-[var(--color-accent-mint)] transition-colors duration-300">Vidya LMS</a></li>
                  <li><a href="#" className="text-white/80 mathco-body-sm hover:text-[var(--color-accent-mint)] transition-colors duration-300">IT Services</a></li>
                </ul>
              </div>
              
              <div>
                <h4 className="text-[var(--color-accent-mint)] mathco-h3 mb-4">Company</h4>
                <ul className="space-y-3">
                  <li><a href="#" className="text-white/80 mathco-body-sm hover:text-[var(--color-accent-mint)] transition-colors duration-300">About Us</a></li>
                  <li><a href="#" className="text-white/80 mathco-body-sm hover:text-[var(--color-accent-mint)] transition-colors duration-300">Contact</a></li>
                  <li><a href="#" className="text-white/80 mathco-body-sm hover:text-[var(--color-accent-mint)] transition-colors duration-300">Privacy Policy</a></li>
                  <li><a href="#" className="text-white/80 mathco-body-sm hover:text-[var(--color-accent-mint)] transition-colors duration-300">Terms of Service</a></li>
                </ul>
              </div>
            </div>
            
            <div className="border-t border-white/20 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
              <p className="text-white/60 mathco-body-sm">&copy; 2025 TheCollegeTech. All rights reserved.</p>
              <div>
                <p className="text-[var(--color-accent-mint)] mathco-body-sm font-medium">Own Your Intelligence in Education</p>
              </div>
            </div>
          </div>
        </footer>
